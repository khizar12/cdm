...
class Ajax_pagination{
	...
	var $last_link		= 'Last';
	var $uri_segment	= 3;
	var $full_tag_open	= '<nav aria-label="Projects Search Navigation"><ul class="pagination pagination-md">';
	var $full_tag_close	= '</ul></nav>';
	var $first_tag_open	= '';
	var $first_tag_close= '</li>';
	var $last_tag_open	= '<li class="page-item">';
	var $last_tag_close	= '';
	var $cur_tag_open	= '<li class="active page-item"><span class="page-link">';
	var $cur_tag_close	= '</span></li>';
	var $next_tag_open	= '<li class="page-item" aria-label="Next">';
	var $next_tag_close	= '</li>';
	var $prev_tag_open	= '<li class="page-item" aria-label="Previous">';
	var $prev_tag_close	= '';
	...
	function create_links(){
		...
		if ($num_pages == 1){
            		$info = '<div class="font-size-h4 font-w600 p-2 mb-4 border-left border-4x border-primary bg-body-light">';
            			$info .= '<span class="text-primary font-w700">';
                            $info .= $this->total_rows;
                        $info .= '</span> record found';
                    $info .= '</div>';
			return $info;
		}
