                    ...
                    <div class="block-content col-md-8 block-content-full tab-content px-md-5" style="min-height: 303px;">
                        ...
                        <div class="tab-pane <?php if($currentTab == 5){ echo "active"; } ?>" id="wizard-simple2-step5" role="tabpanel">
                            ...
                            <form action="#" method="post" id="update_follow_up_form_2" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    <label class="d-block">Pain</label>
                                    <?php if ($follow_up_data_2->pain == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_pain_yes" name="follow_up_2_pain">
                                        <label class="custom-control-label" for="follow_up_2_pain_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="No" id="follow_up_2_pain_no" name="follow_up_2_pain" checked>
                                        <label class="custom-control-label" for="follow_up_2_pain_no">No</label>
                                    </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_pain_yes" name="follow_up_2_pain" <?php echo ($follow_up_data_2->pain == "Yes") ? "checked" : "" ?>>
                                        <label class="custom-control-label" for="follow_up_2_pain_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group">
                                    <label class="d-block">LUTS (Stent Related)</label>
                                    <?php if ($follow_up_data_2->luts == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_luts_yes" name="follow_up_2_luts">
                                            <label class="custom-control-label" for="follow_up_2_luts_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="No" id="follow_up_2_luts_no" name="follow_up_2_luts" checked="">
                                            <label class="custom-control-label" for="follow_up_2_luts_no">No</label>
                                        </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_luts_yes" name="follow_up_2_luts" <?php echo ($follow_up_data_2->luts == "Yes") ? "checked" : "" ?>>
                                            <label class="custom-control-label" for="follow_up_2_luts_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group">
                                    <label class="d-block">UTI</label>
                                    <?php if ($follow_up_data_2->uti == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_uti_yes" name="follow_up_2_uti">
                                        <label class="custom-control-label" for="follow_up_2_uti_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="No" id="follow_up_2_uti_no" name="follow_up_2_uti" checked="">
                                        <label class="custom-control-label" for="follow_up_2_uti_no">No</label>
                                    </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_uti_yes" name="follow_up_2_uti" <?php echo ($follow_up_data_2->uti == "Yes") ? "checked" : "" ?>>
                                        <label class="custom-control-label" for="follow_up_2_uti_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group">
                                    <label class="d-block">Hematuria</label>
                                    <?php if ($follow_up_data_2->hematuria == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_hematuria_yes" name="follow_up_2_hematuria">
                                            <label class="custom-control-label" for="follow_up_2_hematuria_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="No" id="follow_up_2_hematuria_no" name="follow_up_2_hematuria" checked="">
                                            <label class="custom-control-label" for="follow_up_2_hematuria_no">No</label>
                                        </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_hematuria_yes" name="follow_up_2_hematuria" <?php echo ($follow_up_data_2->hematuria == "Yes") ? "checked" : "" ?>>
                                            <label class="custom-control-label" for="follow_up_2_hematuria_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group">
                                    <label class="d-block">Stent Removal</label>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_2_stent_removal_yes" name="follow_up_2_stent_removal" <?php echo ($follow_up_data_2->stent_removal == "Yes") ? "checked" : "" ?>>
                        ...
                        <div class="tab-pane <?php if($currentTab == 6){ echo "active"; } ?>" id="wizard-simple2-step6" role="tabpanel">
                            ...
                            <form action="#" method="post" id="update_follow_up_form_3" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    <label class="d-block">Pain</label>
                                    <?php if ($follow_up_data_3->pain == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_pain_yes" name="follow_up_3_pain">
                                        <label class="custom-control-label" for="follow_up_3_pain_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="No" id="follow_up_3_pain_no" name="follow_up_3_pain" checked>
                                        <label class="custom-control-label" for="follow_up_3_pain_no">No</label>
                                    </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_pain_yes" name="follow_up_3_pain" <?php echo ($follow_up_data_3->pain == "Yes") ? "checked" : "" ?>>
                                        <label class="custom-control-label" for="follow_up_3_pain_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group">
                                    <label class="d-block">LUTS (Stent Related)</label>
                                    <?php if ($follow_up_data_3->luts == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_luts_yes" name="follow_up_3_luts">
                                            <label class="custom-control-label" for="follow_up_3_luts_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="No" id="follow_up_3_luts_no" name="follow_up_3_luts" checked="">
                                            <label class="custom-control-label" for="follow_up_3_luts_no">No</label>
                                        </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_luts_yes" name="follow_up_3_luts" <?php echo ($follow_up_data_3->luts == "Yes") ? "checked" : "" ?>>
                                            <label class="custom-control-label" for="follow_up_3_luts_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group">
                                    <label class="d-block">UTI</label>
                                    <?php if ($follow_up_data_3->uti == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_uti_yes" name="follow_up_3_uti">
                                        <label class="custom-control-label" for="follow_up_3_uti_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="No" id="follow_up_3_uti_no" name="follow_up_3_uti" checked="">
                                        <label class="custom-control-label" for="follow_up_3_uti_no">No</label>
                                    </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_uti_yes" name="follow_up_3_uti" <?php echo ($follow_up_data_3->uti == "Yes") ? "checked" : "" ?>>
                                        <label class="custom-control-label" for="follow_up_3_uti_yes">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <div class="form-group">
                                    <label class="d-block">Hematuria</label>
                                    <?php if ($follow_up_data_3->hematuria == ""): ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_hematuria_yes" name="follow_up_3_hematuria">
                                            <label class="custom-control-label" for="follow_up_3_hematuria_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="No" id="follow_up_3_hematuria_no" name="follow_up_3_hematuria" checked="">
                                            <label class="custom-control-label" for="follow_up_3_hematuria_no">No</label>
                                        </div>
                                    <?php else: ?>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" value="Yes" id="follow_up_3_hematuria_yes" name="follow_up_3_hematuria" <?php echo ($follow_up_data_3->hematuria == "Yes") ? "checked" : "" ?>>
                                            <label class="custom-control-label" for="follow_up_3_hematuria_yes">Yes</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function activeTab(tab_id,tab_content_id,tick_icon_id){
            $(".nav-link").removeClass("active");
            $("#"+tab_id).addClass("active");
            var tick_icon = '<i class="btn btn-form-1-success fa fa-fw fa-check"></i>';
            $("#"+tick_icon_id).prepend(tick_icon);
            $('.tab-pane').removeClass("active");
        ...
        $("#update_form_pre_operative_data").submit(function(e){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    activeTab(tab_id,tab_content_id,tick_icon_id);
                },
                error: function(){
        ...
        $("#scope_evaluation_overall_satisfaction").ionRangeSlider({
            ...
            grid: true,
            skin: "round",
            values: ['Totally Unsatisfied ','Highly Satisfied'],
            step: 10,
       ...
       <?php if ($early_post_operative_data_value->re_admission == "Yes"): ?>
        ...
        $("#update_follow_up_form_3").submit(function(e){
            ...
            $.ajax({
                ...
                async      : false,
                success:function(data){
                    $("#message_follow_up_3_data").html('<div class="alert alert-success alert-dismissable" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><p class="mb-0">Follow Up 3 Data Updated Successfully</p></div>');
